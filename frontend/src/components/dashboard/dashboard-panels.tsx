  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Your tracked sources. New books created here are added to your library
          automatically.
        </CardDescription>
      </CardHeader>
      <CardContent>
...
export function SourceActivityCard({
  ...
  librarySources: Array<{
    ...
    source: LibraryItemWithSource['source']
  }>
  noteContent: string
  notePublic: boolean
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    runAction(
                      () => deleteNote(accessToken, note.id),
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => {
                    if (!accessToken) return
                    runAction(
                      () => deleteReview(accessToken, review.id),
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => {
                    if (!accessToken) return
                    runAction(
                      () => deleteCollection(accessToken, collection.id),
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          <select
            ...
            onChange={event => {
              ...
              runAction(
                () =>
                  updateLibraryItem(accessToken, item.id, {
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              onClick={() => {
                if (!accessToken) return
                runAction(
                  () => deleteLibraryItem(accessToken, item.id),
